const questions1 =[
  ...
  for (let i in questions1) {
    for (let j in questions1[i]) {
      if (!Array.isArray(questions1[i][j])) {
          console.log(`${j} ${questions1[i][j]}`)
      } else {
          for (let k in questions1[i][j]) {
              if (questions1[i][j][k].isCorrect === true) {
                  console.log(questions1[i][j][k].text)
                  console.log(`----------------------------------------------------------------------------`)
              }
          }
      }
